...
/**
 * A class that defines a compound tag
 * 
 * 
 * @version 1.0.0.5
 */
public class CompoundTag extends AbstractTag<Map<String, AbstractTag>> {
     ...
     * @since 1.0.0.0
     */
    public CompoundTag(final String name, final Map<String, AbstractTag> contents) {
        super(name, contents);
    }
     ...
     */
    public CompoundTag() {
        super(new LinkedHashMap<String, AbstractTag>());
    }
    ...
    public CompoundTag(final String name) {
        super(name, new LinkedHashMap<String, AbstractTag>());
    }
     ...
     * @since 1.0.0.0
     */
    public CompoundTag(final Map<String, AbstractTag> contents) {
        super(contents);
    }
