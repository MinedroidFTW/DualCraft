...
/**
 * A class that defines a list tag
 * 
 * 
 * @version 1.1.0.2
 * @param <T> The tag type to use
 */
public class ListTag<T extends AbstractTag> extends AbstractTag<List<T>> {
     ...
     * @since 1.1.0.0
     */
    private final TagType listTagType;
    
    /**
     * Gets the list tag type
     * 
     * @return The list tag type
     * @since 1.1.0.0
     */
     ...
     * @since 1.1.0.0
     */
    public ListTag(final String name, final TagType type, final List<T> contents) {
        super(name, contents);
